	...
	<table align="center" border="1" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="CategoryBean" items="${CategoryBeanList}">
			<tr bordercolor="rgb(78,78,78)">
				<td>${CategoryBean.cname}</td>
				<td>
					<a href="<c:url value='/adminjsps/admin/category/mod.jsp?cid=${CategoryBean.cid}&cname=${CategoryBean.cname}'/>">修改</a> |
					<%--<a href="<c:url value='/adminjsps/admin/category/mod.jsp'/>">修改</a> |--%>
					<a href="<c:url value='/adminjsps/admin/category/del.jsp?cid=${CategoryBean.cid}&cname=${CategoryBean.cname}'/>">删除</a>
